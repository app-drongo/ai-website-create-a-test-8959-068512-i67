...
export default function Hero({
  ...
  description = 'Transform your workflow with AI-powered tools designed for modern teams. Boost productivity by 10x while maintaining enterprise security and compliance.',
  features = [
  ...
  statsLabel1 = 'API Response',
  statsValue1 = '< 50ms avg',
  statsLabel2 = 'Data Processing',
  statsValue2 = '1M+ records/sec',
}: HeroProps) {
