          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamline your business operations with our comprehensive SaaS platform. Join
                thousands of companies who trust our innovative solutions for growth.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Tech Plaza, Innovation District</span>
              </div>
            </div>
